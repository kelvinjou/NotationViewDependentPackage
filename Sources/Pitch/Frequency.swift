...
extension Frequency {
    ...
    public init(noteNumber: NoteNumber, with freqRef: Frequency(value: 440.0), at nnRef: NoteNumber) {
    ...
    public func noteNumber(with freqRef: Frequency(value: 440.0), at nnRef: NoteNumber = 69) -> NoteNumber {
