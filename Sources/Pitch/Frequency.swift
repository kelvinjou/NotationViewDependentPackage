...
extension Frequency {
    ...
    public init(noteNumber: NoteNumber, with freqRef: Frequency, at nnRef: NoteNumber) {
    ...
    public func noteNumber(with freqRef: Frequency, at nnRef: NoteNumber = 69) -> NoteNumber {
